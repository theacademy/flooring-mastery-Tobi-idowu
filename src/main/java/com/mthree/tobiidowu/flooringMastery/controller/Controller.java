...
public class Controller {
    ...
    private void displayOrders() {
        ...
        try {
            ...
            view.errorMessage("Error getting orders for date: " + e.getMessage());
        }
    }
    ...
    private void addOrder() {
        ...
        try {
            ...
            view.errorMessage("Error adding order: " + e.getMessage());
        }
    }
    ...
    private void editOrder() {
        ...
        try {
            ...
            if (existingOrder == null) {
                view.errorMessage("Order not found.");
                return;
            }
            ...
            view.errorMessage("Error editing order: " + e.getMessage());
        } catch (NoSuchOrderException e) {
            view.errorMessage("Error removing order: " + e.getMessage());
        }
    }
    ...
    private void removeOrder() {
        ...
        try {
            // get full order details (will throw NoSuchOrderException if order not found)
            potentialOrder = service.getOrder(potentialOrder.getDate(), potentialOrder.getOrderNumber());
    ...
    private void exportOrder() {
        ...
        try {
            ...
            view.errorMessage("Error exporting data: " + e.getMessage());
        }
    }
